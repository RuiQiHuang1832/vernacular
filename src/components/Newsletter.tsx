...
export default function Newsletter() {
  return (
    ...
    <div className=" d-flex flex-column text-center">
      ...
      <input required type="text" style={{flex:"1 1 0%", padding:"18px"}} placeholder="First Name" className={`form-control ${styles["light-border-input"]}`} />
      <input required type="text" style={{flex:"1 1 0%",padding:"18px"}} placeholder="Email" className={`form-control ${styles["light-border-input"]}`} />
      ...
      <span className="text-decoration-underline">Read our privacy policy.</span>
      </div>
      </div>
  )
}
