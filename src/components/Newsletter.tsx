...
export default function Newsletter() {
  return (
    ...
    <div  className=" d-flex flex-column text-center">
      ...
      <p style={{fontSize:"24px"}} className="mb-5  text-wrap">The Vern newsletter provides creative deep dives, review content, inspiration, and occasional product updates.</p>
      </div>
