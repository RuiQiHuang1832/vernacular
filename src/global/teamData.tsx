...
export interface President {
 ...
 export const presidentList: President[] = [
    ...
    { name: "Abraham Lincoln", title: "VP, Finance & Operations", src: abrahamLincoln, alt: "Abraham Lincoln", description: "Abraham, our financial maestro, keeps Vernacular's operations running smoothly. He is the bedrock of our organization." },
