...
import { FaDatabase, FaDownload,FaPlus } from "react-icons/fa";
  ...
  return (
    <div  className="text-white my-5 mx-auto container p-0">
      <div className="">
        ...
        <h1 className="fw-light"><RiCommunityLine></RiCommunityLine>&nbsp;Community Reviews</h1>
        <hr></hr>
        <section className={`d-flex ${styles["community-banner"]} py-4 px-5 align-items-center my-3 rounded`}>
        ...
        <p className="fw-light">Explore the latest reviews, reshades, and enhancements contributed by our creative community.</p>
          ...
          {Array.from({ length: 2 }).map((e, i) => (
            <div key={i} style={{ flex: "1 0 calc(50% - 8px)" }} className="my-2 position-relative">
              <div className=" w-100" style={{ position: "absolute", bottom: "0", left: "0" }}>
                <div className="p-3 fw-light " style={{ borderRadius:"10px", background: "linear-gradient(to bottom, rgba(0, 0, 0, 0) 0, rgb(4 4 4 / 75%) 100%)", fontSize: "13px" }}>
              ...
              <Image style={{borderRadius:"10px"}} src={[horizon.src, horizon2.src][i]} alt="Home page logo" width={0} height={0} sizes="100vw" className={` h-100 w-100`} priority={true} quality={100} />
            </div>
          ))}
